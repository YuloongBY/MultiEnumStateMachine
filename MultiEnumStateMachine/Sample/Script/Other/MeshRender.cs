...
namespace MultiEnumStateMachine
{
    ...
    public static class MeshRender
    {
        ...
        /// ラウンド
        /// </summary>
        public static MeshFilter RenderRound(GameObject _parent, Vector3 _localPosition, float _radius , Color _color, int _order = 0 , int _segmentation = 30 )
        {
        ...
        /// メッシュ色を設定
        /// </summary>
        public static void SetColor( this MeshFilter _meshFilter , Color _color )
        {
            int vtxCnt = _meshFilter.mesh.vertexCount;
            Color[] colors = new Color[ vtxCnt ];
